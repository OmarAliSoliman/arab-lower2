...
$(document).ready(function () {
  ...
  if ($(".custome-file-validation").length) {
    $(".custome-file-validation").map(function (index, element) {
      ...
      if (
        typeof maxSizeUpload !== typeof undefined &&
        maxSizeUpload !== false
      ) {
  ...
  if ($(".custome-file-validation").length) {
    $("body").on("change", ".custome-file-validation", function () {
      $(this)
        ...
        .parent()
        .find("a")
        .addClass("custome-file-validation-delete");
    });
  ...
  if ($(".personal-img-validation").length) {
    $(".personal-img-validation").map(function (index, element) {
      ...
      $(this)
        ...
        .parent()
        .append(
          "<h6 class='personla-img-max-note'>" +
            maxSizeUpload +
            " ميجا هي اقصى حجم لرفع ملف " +
            "</h6>"
        );
      $(".personal-img-validation")
        .parent()
        .parent()
        .find(".personla-img-max-note")
        .css("display", "block");
      $(this)
        .parent()
        .parent()
  ...
  if ($(".personal-img-validation").length) {
    $("body").on("change", ".personal-img-validation", function (e) {
      ...
      $(this)
        .parent()
        .parent()
        .find(".personal-img-validation-name")
        .css("display", "block");
      $(this)
        .parent()
        .parent()
      ...
      $(this)
        .parent()
        .parent()
        .find(".personal-img-validation-delete")
        .css("display", "inline-block");
    });
  }
  ...
  $("body").append(
    '<div id="context-menu"><div class="item paste-item"><i class="fa fa-paste"></i> لصق</div></div>'
  );
    ...
    $(".paste-item").on("click", function () {
      ...
      navigator.clipboard
        ...
        .then(
          (text) =>
            (targetInput.value =
              targetInput.value.slice(0, curPos) +
              text +
              targetInput.value.slice(endPos))

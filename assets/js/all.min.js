!(function (e, t) {
  ...
  var S = (function (e) {
    ...
    function re(e, t, i, o) {
      ...
      if (
        !o &&
        ((t ? t.ownerDocument || t : _) !== f && p(t), (t = t || f), g)
      ) {
        if (11 !== T && (d = G.exec(e)))
          if ((r = d[1])) {
            if (9 === T) {
    ...
    return (
      ...
      (l = re.select = function (e, t, n, o) {
        ...
        if (((n = n || []), 1 === f.length)) {
          ...
          for (
            r = K.needsContext.test(e) ? 0 : l.length;
  ...
  (w.filter = function (e, t, n) {
    ...
    w.fn.extend({
      ...
      is: function (e) {
        return !!A(this, "string" == typeof e && k.test(e) ? w(e) : e || [], !1)
          .length;
      },
    });
  var D,
      ...
      function (e, t) {
        w.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (I[e] || w.uniqueSort(o), N.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
    ...
    w.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((o = V.get(r)), 1 === r.nodeType && !Q.get(r, "hasDataAttrs"))
          ) {
            for (n = s.length; n--; )
              s[n] &&
        ...
        return "object" == typeof e
          ...
          : z(
              ...
              function (t) {
                var n;
                if (r && void 0 === t) {
                  if (void 0 !== (n = V.get(r, e))) return n;
  ...
  function Ne(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        Q.hasData(e) &&
        ((r = Q.access(e)), (s = Q.set(t, r)), (c = r.events))
      )
        for (o in (delete s.handle, (s.events = {}), c))
          for (n = 0, i = c[o].length; n < i; n++) w.event.add(t, o, c[o][n]);
      V.hasData(e) && ((a = V.access(e)), (l = w.extend({}, a)), V.set(t, l));
    }
  }
  function Ie(e, t) {
    var n = t.nodeName.toLowerCase();
  ...
  function je(e, t, n, i) {
    ...
    var o,
      ...
      m = t[0],
      v = g(m);
    if (v || (p > 1 && "string" == typeof m && !h.checkClone && Ee.test(m)))
  ...
  function Ve(e, t, n) {
    ...
    return (
      ...
      (o = parseFloat(o) || 0) +
        Qe(e, t, n || (r ? "border" : "content"), s, i, o) +
        "px"
    );
  }
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          c = e.style;
        if (
          (l || (t = Ke(a)), (s = w.cssHooks[t] || w.cssHooks[a]), void 0 === n)
        )
        ...
        return "boolean" == typeof t && i
          ...
          : this.each(function () {
              ...
              if (i)
                ...
                (void 0 !== e && "boolean" !== n) ||
                  ((t = pt(this)) && Q.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  (jt.href = vt.href),
    w.extend({
      ...
      ajax: function (t, n) {
        ...
        h.ifModified &&
          (w.lastModified[r] &&
            x.setRequestHeader("If-Modified-Since", w.lastModified[r]),
          w.etag[r] && x.setRequestHeader("If-None-Match", w.etag[r])),
        ...
        if (
          ...
          if (((x.readyState = 1), d && m.trigger("ajaxSend", [x, h]), u))
            return x;
          h.async &&
            h.timeout > 0 &&
        ...
        function C(t, n, i, a) {
          ...
          u ||
            ...
            c
              ? (h.ifModified &&
                  ((T = x.getResponseHeader("Last-Modified")) &&
                    (w.lastModified[r] = T),
                  (T = x.getResponseHeader("etag")) && (w.etag[r] = T)),
                204 === t || "HEAD" === h.type
                  ? (S = "nocontent")
                  : 304 === t
                  ? (S = "notmodified")
                  : ((S = _.state), (p = _.data), (c = !(f = _.error))))
            ...
            x.statusCode(b),
            (b = void 0),
            d && m.trigger(c ? "ajaxSuccess" : "ajaxError", [x, h, c ? p : f]),
            y.fireWith(g, [x, S]),
            d &&
  ...
  w.ajaxSetup({
    ...
    w.each(["top", "left"], function (e, t) {
      w.cssHooks[t] = Re(h.pixelPosition, function (e, n) {
        if (n)
          return (n = Me(e, t)), Pe.test(n) ? w(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (w.noConflict = function (t) {
      return e.$ === w && (e.$ = Ft), t && e.jQuery === w && (e.jQuery = zt), w;
    }),
    t || (e.jQuery = e.$ = w),
    w
  );
  ...
  (function (e, t) {
    ...
    function g(e, n) {
      ...
      r && a && ((u.top = W(u.top, 0)), (u.left = W(u.left, 0)));
      var v = f({
        top: l.top - u.top - g,
    ...
    for (
      ...
      if (z && 0 <= navigator.userAgent.indexOf(F[B])) {
        U = 1;
        break;
      }
    var Y =
          ...
          arrow: {
            ...
            fn: function (e, n) {
              ...
              return (
                (_ = W(q(a[u] - m, _), 0)),
                (e.arrowElement = o),
                (e.offsets.arrow = (G((i = {}), p, R(_)), G(i, h, ""), i)),
                e
              );
            },
            element: "[x-arrow]",
  ...
  (function (e, t) {
    ...
    t(document)
      ...
      (t.fn[h] = S._jQueryInterface),
      (t.fn[h].Constructor = S),
      (t.fn[h].noConflict = function () {
        return (t.fn[h] = y), S._jQueryInterface;
      });
    var x = "carousel",
      C = "bs.carousel",
      k = "." + C,
      ...
      q = (function () {
        ...
        return (
          ...
          (n._getConfig = function (e) {
            return (e = r({}, A, e)), a.typeCheckConfig(x, e, D), e;
          }),
    ...
    t(document).on(
      ...
      (t.fn[x].noConflict = function () {
        return (t.fn[x] = $), q._jQueryInterface;
      });
    var M = "collapse",
      R = "bs.collapse",
      W = "." + R,
      ...
      G = (function () {
        ...
        return (
          ...
          (n.show = function () {
            ...
            if (
              ...
              if ((t(this._element).trigger(r), !r.isDefaultPrevented())) {
                ...
                t(this._element)
                  .one(a.TRANSITION_END, function () {
                    t(o._element).removeClass(X).addClass(K).addClass(Y),
                      (o._element.style[s] = ""),
                      o.setTransitioning(!1),
                      t(o._element).trigger(B.SHOWN);
                  })
            ...
            if (!this._isTransitioning && t(this._element).hasClass(Y)) {
              ...
              if ((t(this._element).trigger(n), !n.isDefaultPrevented())) {
                ...
                (this._element.style[i] =
                  ...
                  t(this._element).addClass(X).removeClass(K).removeClass(Y);
                  ...
                  for (var r = 0; r < o; r++) {
                    ...
                    null !== l &&
                      (t([].slice.call(document.querySelectorAll(l))).hasClass(
                        ...
                        t(s).addClass(Q).attr("aria-expanded", !1));
                  }
          ...
          (n._addAriaAndCollapsedClass = function (e, n) {
            ...
            n.length && t(n).toggleClass(Q, !i).attr("aria-expanded", i);
          }),
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              var i = t(this),
                o = i.data(R),
                s = r({}, F, i.data(), "object" == typeof n && n ? n : {});
              if (
    ...
    t(document).on(B.CLICK_DATA_API, V, function (e) {
      ...
      (t.fn[M].noConflict = function () {
        return (t.fn[M] = z), G._jQueryInterface;
      });
    var Z = "dropdown",
      J = "bs.dropdown",
      ee = "." + J,
    ...
    var fe = "modal",
      ...
      ke = (function () {
        function e(e, t) {
          (this._config = this._getConfig(t)),
            (this._element = e),
            (this._dialog = e.querySelector(Se)),
            (this._backdrop = null),
            (this._isShown = !1),
    ...
    t(document).on(be.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
      ...
      (t.fn[fe] = ke._jQueryInterface),
      (t.fn[fe].Constructor = ke),
      (t.fn[fe].noConflict = function () {
        return (t.fn[fe] = me), ke._jQueryInterface;
      });
    var Ee = [
        "background",
        "cite",
            ...
            a.forEach(function (e) {
              (function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === Ee.indexOf(n) ||
                    Boolean(e.nodeValue.match($e) || e.nodeValue.match(Ae))
                  );
                for (
        ...
        return (
          ...
          (i.toggle = function (e) {
            if (this._isEnabled)
              if (e) {
                ...
                if (t(this.getTipElement()).hasClass(Ue))
          ...
          (i.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              s.setAttribute("id", l),
                ...
                this.setContent(),
                this.config.animation && t(s).addClass(Fe);
              var c =
          ...
          (i._enter = function (e, n) {
            ...
            (n = n || t(e.currentTarget).data(i)) ||
              ...
              e && (n._activeTrigger["focusin" === e.type ? Ye : Be] = !0),
              t(n.getTipElement()).hasClass(Ue) || n._hoverState === We
                ? (n._hoverState = We)
          ...
          (i._leave = function (e, n) {
            ...
            (n = n || t(e.currentTarget).data(i)) ||
              ...
              t(e.currentTarget).data(i, n)),
              e && (n._activeTrigger["focusout" === e.type ? Ye : Be] = !1),
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              var i = t(this).data(Ne),
                o = "object" == typeof n && n;
              if (
                (i || !/dispose|hide/.test(n)) &&
                (i || ((i = new e(this, o)), t(this).data(Ne, i)),
                "string" == typeof n)
              ) {
                if (void 0 === i[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (t.fn[Oe] = Ke._jQueryInterface),
      (t.fn[Oe].Constructor = Ke),
      (t.fn[Oe].noConflict = function () {
        return (t.fn[Oe] = je), Ke._jQueryInterface;
      });
    var Xe = "popover",
      Qe = "bs.popover",
      Ve = "." + Qe,
      ...
      tt = r({}, Ke.DefaultType, { content: "(string|element|function)" }),
      nt = {
        HIDE: "hide" + Ve,
        HIDDEN: "hidden" + Ve,
        SHOW: "show" + Ve,
          ...
          (r._jQueryInterface = function (e) {
            return this.each(function () {
              ...
              if (
                ...
                (n || ((n = new r(this, i)), t(this).data(Qe, n)),
                "string" == typeof e)
              ) {
                if (void 0 === n[e])
    ...
    (t.fn[Xe] = it._jQueryInterface),
      (t.fn[Xe].Constructor = it),
      (t.fn[Xe].noConflict = function () {
        return (t.fn[Xe] = Ge), it._jQueryInterface;
      });
    var ot = "scrollspy",
      rt = "bs.scrollspy",
      st = "." + rt,
        ...
        return (
          (n.show = function () {
            ...
            if (
              ...
              if (o) {
                var s = "UL" === o.nodeName || "OL" === o.nodeName ? xt : St;
    ...
    var kt = "toast",
      ...
      jt = { animation: !0, autohide: !0, delay: 500 },
      Lt = (function () {
        function e(e, t) {
          (this._element = e),
            (this._config = this._getConfig(t)),
        ...
        return (
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (o ||
                  ((o = new e(this, "object" == typeof n && n)), i.data(Et, o)),
                "string" == typeof n)
              ) {
                if (void 0 === o[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (t.fn[kt] = Lt._jQueryInterface),
      (t.fn[kt].Constructor = Lt),
      (t.fn[kt].noConflict = function () {
        return (t.fn[kt] = At), Lt._jQueryInterface;
      }),
      (function () {
        if (void 0 === t)
          throw new TypeError(
  ...
  (function (e, t) {
          ...
          (function (e, n, i) {
            ...
            function S() {
              ...
              if (((o = arguments), (r = this), (c = e), t)) {
                if (void 0 === l)
                  return (function (e) {
                    return (u = e), (l = setTimeout(_, n)), d ? b(e) : a;
                  })(c);
                if (p) return (l = setTimeout(_, n)), b(c);
              }
    ...
    function j(e) {
      ...
      e = e.replace(_, "");
      var n = S.test(e);
      return n || x.test(e) ? C(e.slice(2), n ? 2 : 8) : T.test(e) ? b : +e;
    }
    var L = function (e, t, n) {
        ...
        return (
          ...
          I(n) &&
            ((u = !!n.leading),
            (r = (d = "maxWait" in n) ? D(j(n.maxWait) || 0, t) : r),
            (p = "trailing" in n ? !!n.trailing : p)),
          (v.cancel = function () {
            void 0 !== a && clearTimeout(a), (c = 0), (i = l = o = a = void 0);
          }),
          (v.flush = function () {
            return void 0 === a ? s : m(N());
          }),
          v
        );
      },
              ...
              r =
                ...
                function () {
                  e.animated &&
                    ...
                    V("aos:out", o),
                    e.options.id && V("aos:in:" + e.options.id, o),
                    (e.animated = !1));
                });
          ...
          le(ie.disable) || oe()
            ...
            : (document
              ...
              "DOMContentLoaded" === ie.startEvent &&
                ...
                re(!0),
              window.addEventListener("resize", L(re, ie.debounceDelay, !0)),
              window.addEventListener(
                "orientationchange",
                L(re, ie.debounceDelay, !0)
              ),
              te)
        );
      },
                    ...
                    if (
                      ...
                      for (
                        ...
                        if ("require" === (d = (f = h(n[y], w)).f))
                          ...
                          (T[y] = g.exports(e)), (_ = !0);
                        else if ("module" === d) c = T[y] = g.module(e);
                        else if (o(m, d) || o(v, d) || o(b, d)) T[y] = l(d);
                        else {
                          if (!f.p) throw new Error(e + " missing " + d);
                          f.p.load(f.n, s(r, !0), a(d), {}), (T[y] = m[d]);
                        }
                      (p = i ? i.apply(m[e], T) : void 0),
                        e &&
                ...
                (A.prototype.apply = function (d) {
                  ...
                  if (null == d.selectionAdapter) {
                    if (
                      ...
                      var N = t(d.amdBase + "compat/containerCss");
                      d.selectionAdapter = c.Decorate(d.selectionAdapter, N);
                    }
      ...
      ($("body").on("change", ".time-start-select", function () {
        (e = $(this)
          ...
          (t = $(this)
            ...
            .val()) <= e &&
            (alert(
              "لابد أن يكون الساعة ( إلى )  أكبر من الساعة ( من )"
            ),
            $(this)
              .parent()
              .parent()
        ...
        ($("body").on("change", ".date-start-select", function () {
          (e = $(this)
            ...
            (t = $(this)
              ...
              .val()) < e &&
              (alert(
                "لابد أن يكون التاريخ ( إلى )  أكبر من التاريخ ( من )"
              ),
              $(this)
                .parent()
                .parent()

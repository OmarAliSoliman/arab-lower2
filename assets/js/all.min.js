!(function (e, t) {
  ...
  var T = (function (e) {
    ...
    function re(e, t, i, o) {
      ...
      if (
        !o &&
        ((t ? t.ownerDocument || t : x) !== f && p(t), (t = t || f), g)
      ) {
        if (11 !== _ && (d = G.exec(e)))
          if ((r = d[1])) {
            if (9 === _) {
      ...
      return (
        ...
        ae(function (r, s, a, l) {
          var c,
            ...
            v = n ? (o || (r ? e : h || i) ? [] : s) : m;
          if ((n && n(m, v, a, l), i))
            for (c = we(v, f), i(c, [], a, l), u = c.length; u--; )
              (d = c[u]) && (v[f[u]] = !(m[f[u]] = d));
          if (r) {
            if (o || e) {
              if (o) {
          ...
          } else (v = we(v === s ? v.splice(h, v.length) : v)), o ? o(null, s, v, l) : P.apply(s, v);
        })
      );
    }
    function _e(e) {
  ...
  (w.filter = function (e, t, n) {
    ...
    w.fn.extend({
      ...
      is: function (e) {
        return !!A(this, "string" == typeof e && $.test(e) ? w(e) : e || [], !1)
          .length;
      },
    });
  var D,
      ...
      function (e, t) {
        w.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (I[e] || w.uniqueSort(o), P.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
        ...
        var n = [
          ...
          o = {
            ...
            then: function (t, i, o) {
              ...
              return w
                .Deferred(function (e) {
                  n[0][3].add(s(0, e, g(o) ? o : N, e.notifyWith)),
                    n[1][3].add(s(0, e, g(t) ? t : N)),
  ...
  function Le(e, t, n, i) {
    ...
    var o,
      ...
      m = t[0],
      v = g(m);
    if (v || (p > 1 && "string" == typeof m && !h.checkClone && ke.test(m)))
    ...
    if (
      p &&
      ((r = (o = me(t, e[0].ownerDocument, !1, e, i)).firstChild),
      1 === o.childNodes.length && (o = r),
      r || i)
    ) {
      for (l = (a = w.map(fe(o, "script"), De)).length; d < p; d++)
        (c = o),
          d !== f &&
            ((c = w.clone(c, !0, !0)), l && w.merge(a, fe(c, "script"))),
          n.call(e[d], c, d);
      if (l)
        for (u = a[a.length - 1].ownerDocument, w.map(a, Oe), d = 0; d < l; d++)
          (c = a[d]),
            de.test(c.type || "") &&
              ...
              (c.src && "module" !== (c.type || "").toLowerCase()
                ...
                : y(c.textContent.replace(Ee, ""), u, c));
    }
    return e;
  }
  function je(e, t, n) {
    for (var i, o = t ? w.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || w.cleanData(fe(i)),
        i.parentNode &&
          (n && w.contains(i.ownerDocument, i) && he(fe(i, "script")),
  ...
  w.extend({
    ...
    w.each(["height", "width"], function (e, t) {
      w.cssHooks[t] = {
        get: function (e, n, i) {
          if (n)
            return !Fe.test(w.css(e, "display")) ||
        ...
        if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              g && le([e], !0),
              p.done(function () {
                for (i in (g || le([e]), K.remove(e, "fxshow"), f))
                  w.style(e, i, f[i]);
              })),
              (l = rt(g ? m[i] : 0, i, p)),
              i in m ||
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : ct.test(e.nodeName) || (ut.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && i
          ...
          : this.each(function () {
              var t, o, r, s;
              if (i)
                for (o = 0, r = w(this), s = ft(e); (t = s[o++]); )
                  r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = pt(this)) && K.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  w.extend(w.event, {
    trigger: function (t, n, o, r) {
      ...
      if (
        ...
        if (!r && !f.noBubble && !m(o)) {
          for (
            c = f.delegateType || y, gt.test(c + y) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            v.push(a), (l = a);
      ...
      ajax: function (t, n) {
        ...
        h.hasContent
          ...
          : ((f = h.url.slice(r.length)),
            h.data &&
              ...
              ((r += (bt.test(r) ? "&" : "?") + h.data), delete h.data),
            !1 === h.cache &&
              ((r = r.replace(kt, "$1")),
              (f = (bt.test(r) ? "&" : "?") + "_=" + yt++ + f)),
            (h.url = r + f)),
        ...
        function C(t, n, i, a) {
          ...
          u ||
            ...
            c
              ? (h.ifModified &&
                  ((_ = S.getResponseHeader("Last-Modified")) &&
                    (w.lastModified[r] = _),
                  (_ = S.getResponseHeader("etag")) && (w.etag[r] = _)),
                204 === t || "HEAD" === h.type
                  ? (T = "nocontent")
                  : 304 === t
                  ? (T = "notmodified")
            ...
            (S.status = t),
            (S.statusText = (n || T) + ""),
            c ? v.resolveWith(g, [p, T, S]) : v.rejectWith(g, [S, T, f]),
            S.statusCode(b),
            (b = void 0),
  ...
  w.ajaxSetup({
    ...
    (w.fn.load = function (e, t, n) {
      var i,
        ...
        a = e.indexOf(" ");
      return (
        a > -1 && ((i = dt(e.slice(a))), (e = e.slice(0, a))),
        g(t)
          ? ((n = t), (t = void 0))
    ...
    w.each(["top", "left"], function (e, t) {
      w.cssHooks[t] = Re(h.pixelPosition, function (e, n) {
        if (n)
          return (n = qe(e, t)), Ne.test(n) ? w(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (w.noConflict = function (t) {
      return e.$ === w && (e.$ = Wt), t && e.jQuery === w && (e.jQuery = zt), w;
    }),
    t || (e.jQuery = e.$ = w),
    w
  );
  ...
  (function (e, t) {
    ...
    for (
      ...
      if (z && 0 <= navigator.userAgent.indexOf(W[U])) {
        B = 1;
        break;
      }
    var Y =
      ...
      X = z && !(!window.MSInputMethodContext || !document.documentMode),
      V = z && /MSIE 10/.test(navigator.userAgent),
      K = function (e, t) {
        if (!(e instanceof t))
      ...
      J = z && /Firefox/i.test(navigator.userAgent),
      ee = [
        "auto-start",
        "auto",
        "auto-end",
      ...
      re = (function () {
        function t(n, i) {
          ...
          K(this, t),
            ...
            Object.keys(Z({}, t.Defaults.modifiers, r.modifiers)).forEach(
              function (e) {
                o.options.modifiers[e] = Z(
                  {},
            ...
            (this.modifiers = Object.keys(this.options.modifiers)
              .map(function (e) {
                return Z({ name: e }, o.options.modifiers[e]);
              })
              .sort(function (e, t) {
          ...
          arrow: {
            ...
            fn: function (e, n) {
              ...
              return (
                (x = F(M(a[u] - m, x), 0)),
                (e.arrowElement = o),
                (e.offsets.arrow = (G((i = {}), p, R(x)), G(i, h, ""), i)),
                e
              );
            },
            element: "[x-arrow]",
          ...
          applyStyle: {
            ...
            fn: function (e) {
              return (
                ...
                e.arrowElement &&
                  ...
                  L(e.arrowElement, e.arrowStyles),
                e
              );
            },
            onLoad: function (e, t, n, i, o) {
              ...
              return (
                ...
                L(t, { position: n.positionFixed ? "fixed" : "absolute" }),
                n
              );
            },
  ...
  (function (e, t) {
    ...
    t(document).on(
      ...
      (t.fn[l] = f._jQueryInterface),
      (t.fn[l].Constructor = f),
      ...
      T = (function () {
        ...
        return (
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              var i = t(this).data(g);
              i || ((i = new e(this)), t(this).data(g, i)),
                "toggle" === n && i[n]();
            });
          }),
          o(e, null, [
    ...
    t(document)
      .on(_.CLICK_DATA_API, w, function (e) {
        e.preventDefault();
        var n = e.target;
        t(n).hasClass("btn") || (n = t(n).closest(x)),
      ...
      (t.fn[h] = T._jQueryInterface),
      (t.fn[h].Constructor = T),
      (t.fn[h].noConflict = function () {
        return (t.fn[h] = y), T._jQueryInterface;
      });
    var S = "carousel",
      C = "bs.carousel",
      $ = "." + C,
      ...
      I = {
        ...
        LOAD_DATA_API: "load" + $ + k,
        CLICK_DATA_API: "click" + $ + k,
      },
      L = "active",
      ...
      M = (function () {
        function e(e, t) {
          (this._items = null),
            ...
            (this._element = e),
            (this._indicatorsElement = this._element.querySelector(N)),
        ...
        return (
          ...
          (n._getConfig = function (e) {
            return (e = r({}, A, e)), a.typeCheckConfig(S, e, D), e;
          }),
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (i || ((i = new e(this, o)), t(this).data(C, i)),
                "number" == typeof n)
              )
                i.to(n);
    ...
    t(document).on(
      ...
      (t.fn[S] = M._jQueryInterface),
      (t.fn[S].Constructor = M),
      (t.fn[S].noConflict = function () {
        return (t.fn[S] = E), M._jQueryInterface;
      });
    var q = "collapse",
      R = "bs.collapse",
      F = "." + R,
      ...
      G = (function () {
        ...
        return (
            ...
            if (
              !(
                ...
                (this._parent &&
                  ...
                  (n = null),
                n &&
                  (i = t(n).not(this._selector).data(R)) &&
                  i._isTransitioning)
              )
            ) {
              ...
              if ((t(this._element).trigger(r), !r.isDefaultPrevented())) {
                ...
                t(this._element)
                  .one(a.TRANSITION_END, function () {
                    t(o._element).removeClass(V).addClass(X).addClass(Y),
                      (o._element.style[s] = ""),
            ...
            if (!this._isTransitioning && t(this._element).hasClass(Y)) {
              ...
              if ((t(this._element).trigger(n), !n.isDefaultPrevented())) {
                ...
                (this._element.style[i] =
                  ...
                  t(this._element).addClass(V).removeClass(X).removeClass(Y);
                  ...
                  for (var r = 0; r < o; r++) {
                    ...
                    null !== l &&
                      (t([].slice.call(document.querySelectorAll(l))).hasClass(
                        ...
                        t(s).addClass(K).attr("aria-expanded", !1));
                  }
          ...
          (n._getConfig = function (e) {
            return (
              ((e = r({}, W, e)).toggle = Boolean(e.toggle)),
              a.typeCheckConfig(q, e, B),
              e
            );
          }),
    ...
    t(document).on(U.CLICK_DATA_API, Q, function (e) {
      ...
      (t.fn[q] = G._jQueryInterface),
      (t.fn[q].Constructor = G),
      (t.fn[q].noConflict = function () {
        return (t.fn[q] = z), G._jQueryInterface;
      });
    var Z = "dropdown",
      J = "bs.dropdown",
      ee = "." + J,
        ...
        return (
              ...
              if ((e._clearMenus(), !o)) {
                ...
                if ((t(i).trigger(s), !s.isDefaultPrevented())) {
                  ...
                  "ontouchstart" in document.documentElement &&
                    ...
                    t(i).toggleClass(se).trigger(t.Event(oe.SHOWN, r));
                }
              }
            }
          }),
            ...
            if (
              ...
              t(o).trigger(i),
                i.isDefaultPrevented() ||
                  (t(this._menu).toggleClass(se),
                  t(o).toggleClass(se).trigger(t.Event(oe.SHOWN, n)));
            }
          }),
          (i.hide = function () {
            if (
              ...
              t(o).trigger(i),
                i.isDefaultPrevented() ||
                  (t(this._menu).toggleClass(se),
                  t(o).toggleClass(se).trigger(t.Event(oe.HIDDEN, n)));
            }
          }),
          (i.dispose = function () {
          ...
          (i._getConfig = function (e) {
            return (
              ...
              a.typeCheckConfig(Z, e, this.constructor.DefaultType),
              e
            );
          }),
          ...
          (e._clearMenus = function (n) {
            if (!n || (3 !== n.which && ("keyup" !== n.type || 9 === n.which)))
              for (
                var i = [].slice.call(document.querySelectorAll(le)),
                  o = 0,
                  r = i.length;
                o < r;
                o++
                  ...
                  if (
                    ...
                    t(s).trigger(u),
                      u.isDefaultPrevented() ||
                        ...
                        t(c).removeClass(se),
                        t(s).removeClass(se).trigger(t.Event(oe.HIDDEN, l)));
                  }
                }
              }
          }),
                ...
                ? !(
                    ...
                    (27 !== n.which &&
                      ((40 !== n.which && 38 !== n.which) ||
                        t(n.target).closest(ce).length))
                  )
                : ie.test(n.which)) &&
              (n.preventDefault(),
              n.stopPropagation(),
              !this.disabled && !t(this).hasClass(re))
            ) {
    ...
    t(document)
      .on(oe.KEYDOWN_DATA_API, le, pe._dataApiKeydownHandler)
      ...
      (t.fn[Z] = pe._jQueryInterface),
      (t.fn[Z].Constructor = pe),
      (t.fn[Z].noConflict = function () {
        return (t.fn[Z] = ne), pe._jQueryInterface;
      });
    var fe = "modal",
      he = "bs.modal",
      ge = "." + he,
        ...
        return (
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  t(this._element).removeClass(_e),
          ...
          (e._jQueryInterface = function (n, i) {
            return this.each(function () {
              ...
              if (
                (o || ((o = new e(this, s)), t(this).data(he, o)),
                "string" == typeof n)
              ) {
                if (void 0 === o[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    t(document).on(be.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
      ...
      $e._jQueryInterface.call(t(n), s, this);
    }),
      (t.fn[fe] = $e._jQueryInterface),
      (t.fn[fe].Constructor = $e),
      (t.fn[fe].noConflict = function () {
        return (t.fn[fe] = me), $e._jQueryInterface;
      });
    var ke = [
        "background",
        "cite",
            ...
            a.forEach(function (e) {
              (function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === ke.indexOf(n) ||
                    Boolean(e.nodeValue.match(Ee) || e.nodeValue.match(Ae))
                  );
                for (
        ...
        return (
          ...
          (i.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              s.setAttribute("id", l),
                ...
                this.setContent(),
                this.config.animation && t(s).addClass(We);
              var c =
          ...
          (i.setContent = function () {
            ...
            this.setElementContent(
              ...
              t(e).removeClass(We + " " + Be);
          }),
          (i.setElementContent = function (e, n) {
            "object" != typeof n || (!n.nodeType && !n.jquery)
              ? this.config.html
                ? (this.config.sanitize &&
                    (n = De(n, this.config.whiteList, this.config.sanitizeFn)),
                  e.html(n))
                : e.text(n)
              : this.config.html
          ...
          (i._enter = function (e, n) {
            ...
            (n = n || t(e.currentTarget).data(i)) ||
              ...
              e && (n._activeTrigger["focusin" === e.type ? Ye : Ue] = !0),
              t(n.getTipElement()).hasClass(Be) || n._hoverState === Fe
                ? (n._hoverState = Fe)
          ...
          (i._leave = function (e, n) {
            ...
            (n = n || t(e.currentTarget).data(i)) ||
              ...
              t(e.currentTarget).data(i, n)),
              e && (n._activeTrigger["focusout" === e.type ? Ye : Ue] = !1),
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                (i || ((i = new e(this, o)), t(this).data(Pe, i)),
                "string" == typeof n)
              ) {
                if (void 0 === i[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (t.fn[Oe] = Xe._jQueryInterface),
      ...
      (t.fn[Oe].noConflict = function () {
        return (t.fn[Oe] = Le), Xe._jQueryInterface;
      });
    var Ve = "popover",
      Ke = "bs.popover",
      Qe = "." + Ke,
      ...
      tt = r({}, Xe.DefaultType, { content: "(string|element|function)" }),
      nt = {
        HIDE: "hide" + Qe,
        HIDDEN: "hidden" + Qe,
        SHOW: "show" + Qe,
          ...
          (r._jQueryInterface = function (e) {
            return this.each(function () {
              ...
              if (
                ...
                (n || ((n = new r(this, i)), t(this).data(Ke, n)),
                "string" == typeof e)
              ) {
                if (void 0 === n[e])
      ...
      vt = (function () {
        ...
        return (
          ...
          (n._getConfig = function (e) {
            if (
              "string" !=
              typeof (e = r({}, lt, "object" == typeof e && e ? e : {})).target
            ) {
              var n = t(e.target).attr("id");
              n || ((n = a.getUID(ot)), t(e.target).attr("id", n)),
                (e.target = "#" + n);
            }
          ...
          (n._activate = function (e) {
            ...
            i.hasClass("dropdown-item")
              ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(dt),
                i.addClass(dt))
              : (i.addClass(dt),
                i
                  .parents(pt)
                  .prev(ft + ", " + ht)
                  .addClass(dt),
                i.parents(pt).prev(".nav-item").children(ft).addClass(dt)),
        ...
        return (
          (n.show = function () {
            ...
            if (
              ...
              if (o) {
                var s = "UL" === o.nodeName || "OL" === o.nodeName ? St : Tt;
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              var i = t(this),
                o = i.data(yt);
              if (
                (o || ((o = new e(this)), i.data(yt, o)), "string" == typeof n)
              ) {
                if (void 0 === o[n])
                  throw new TypeError('No method named "' + n + '"');
                o[n]();
    ...
    t(document).on(
      ...
      (t.fn.tab.noConflict = function () {
        return (t.fn.tab = wt), Ct._jQueryInterface;
      });
    var $t = "toast",
      kt = "bs.toast",
      Et = "." + kt,
        ...
        return (
          ...
          (n.hide = function (e) {
            ...
            this._element.classList.contains(Ot) &&
              (t(this._element).trigger(Dt.HIDE),
              e
                ? this._close()
          ...
          (n.dispose = function () {
            clearTimeout(this._timeout),
              ...
              t(this._element).off(Dt.CLICK_DISMISS),
          ...
          (n._getConfig = function (e) {
            return (
              ...
              a.typeCheckConfig($t, e, this.constructor.DefaultType),
              e
            );
          }),
            ...
            var e = this,
              n = function () {
                e._element.classList.add("hide"),
                  t(e._element).trigger(Dt.HIDDEN);
              };
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (o ||
                  ((o = new e(this, "object" == typeof n && n)), i.data(kt, o)),
                "string" == typeof n)
              ) {
                if (void 0 === o[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (t.fn[$t] = jt._jQueryInterface),
      (t.fn[$t].Constructor = jt),
      (t.fn[$t].noConflict = function () {
        return (t.fn[$t] = At), jt._jQueryInterface;
      }),
      (function () {
        if (void 0 === t)
          throw new TypeError(
  ...
  (function (e, t) {
    ...
    function v(e) {
      ...
      e = e.replace(o, "");
      var c = s.test(e);
      return c || a.test(e) ? l(e.slice(2), c ? 2 : 8) : r.test(e) ? n : +e;
    }
    var y = function (e, n, i) {
        ...
        return (
          ...
          (function (e, n, i) {
            ...
            function T() {
              ...
              if (((o = arguments), (r = this), (c = e), t)) {
                if (void 0 === l)
                  return (function (e) {
                    return (u = e), (l = setTimeout(x, n)), d ? b(e) : a;
                  })(c);
                if (p) return (l = setTimeout(x, n)), b(c);
              }
            ...
            return (
              ...
              m(i) &&
                ((d = !!i.leading),
                (s = (p = "maxWait" in i) ? f(v(i.maxWait) || 0, n) : s),
          ...
          })(e, n, { leading: o, maxWait: n, trailing: r })
        );
      },
      b = NaN,
      w = "[object Symbol]",
    ...
    function L(e) {
      ...
      e = e.replace(x, "");
      var n = T.test(e);
      return n || S.test(e) ? C(e.slice(2), n ? 2 : 8) : _.test(e) ? b : +e;
    }
    var j = function (e, t, n) {
        ...
        function v() {
          ...
          if (((i = arguments), (o = this), (l = e), n)) {
            if (void 0 === a)
              return (function (e) {
                return (c = e), (a = setTimeout(g, t)), u ? f(e) : s;
              })(l);
            if (d) return (a = setTimeout(g, t)), f(l);
          }
        ...
        return (
          ...
          I(n) &&
            ((u = !!n.leading),
            (r = (d = "maxWait" in n) ? D(L(n.maxWait) || 0, t) : r),
            (p = "trailing" in n ? !!n.trailing : p)),
          (v.cancel = function () {
            void 0 !== a && clearTimeout(a), (c = 0), (i = l = o = a = void 0);
          }),
          (v.flush = function () {
            return void 0 === a ? s : m(P());
          }),
          v
        );
      },
    ...
    var K = new ((function () {
          ...
          z(e, [
            {
              ...
              value: function () {
                var e = V();
                return !(!B.test(e) && !U.test(e.substr(0, 4)));
              },
            },
            {
              key: "mobile",
      ...
      re = function () {
        ...
        arguments.length > 0 &&
          ...
          ne &&
            ((t = ie),
            (e = te).forEach(function (e, n) {
              var i = J(e.node, "mirror", t.mirror),
                o = J(e.node, "once", t.once),
                r = J(e.node, "id"),
                ...
                (e.position = {
                  in: (function (e, t, n) {
                    var i = window.innerHeight,
                      o = J(e, "anchor"),
                      r = J(e, "anchor-placement"),
                      s = Number(J(e, "offset", r ? 0 : t)),
                      a = r || n,
                      l = e;
                    o &&
      ...
      se = function () {
        if (((te = ee()), le(ie.disable) || oe())) return ae();
        re();
      },
      ae = function () {
    ...
    return {
      init: function (e) {
        return (
          ...
          ie.disableMutationObserver || R("[data-aos]", se),
          le(ie.disable) || oe()
            ? ae()
            : (document
                .querySelector("body")
              ...
              "DOMContentLoaded" === ie.startEvent &&
                ...
                re(!0),
              window.addEventListener("resize", j(re, ie.debounceDelay, !0)),
              window.addEventListener(
                "orientationchange",
                j(re, ie.debounceDelay, !0)
              ),
              te)
        );
      },
      ...
      n.extend(g.prototype, {
        ...
        jumpTo: function (e, t) {
          ...
          if (!(f.isDragging || f.isClosing || (f.isAnimating && f.firstRun))) {
            ...
            if (
              ...
              (s = f.createSlide(e)),
              h > 1 &&
                ((r || s.index < h - 1) && f.createSlide(e + 1),
              ...
              n.isNumeric(t)
                ? (s.forcedDuration = t)
                : (t = s.opts[i ? "animationDuration" : "transitionDuration"]),
              (t = parseInt(t, 10)),
              (o = f.isMoved(s)),
        ...
        scaleToActual: function (e, t, i) {
          ...
          c.isAnimating ||
            ...
            (e = void 0 === e ? 0.5 * p : e),
            (t = void 0 === t ? 0.5 * f : t),
            ((o = n.fancybox.getTranslate(d)).top -= n.fancybox.getTranslate(
              u.$slide
            ).top),
                ...
                i.isClosing ||
                  (e.opts.srcset &&
                    (((t = e.opts.sizes) && "auto" !== t) ||
                      (t =
                        (e.width / e.height > 1 && s.width() / s.height() > 1
                          ? "100"
            ...
            "zoom" === t
              ? ((s.isAnimating = !0),
                ...
                "auto" == (r = e.opts.zoomOpacity) &&
                  (r = Math.abs(e.width / e.height - c.width / c.height) > 0.1),
        ...
        trigger: function (e, t) {
          ...
          if (
            ...
            return i;
          "afterClose" !== e && r.$refs
            ? r.$refs.container.trigger(e + ".fb", o)
            : a.trigger(e + ".fb", o);
        },
        updateControls: function () {
          ...
          i.$slide.trigger("refresh"),
            a && a.length
              ? ((e.$caption = s), s.children().eq(0).html(a))
              : (e.$caption = null),
      ...
      (s = e.extend(!0, {}, t, r.opts.media)),
        e.each(s, function (t, i) {
          if ((l = f.match(i.matcher))) {
            if (
              ((h = i.type), (p = t), (d = {}), i.paramPlace && l[i.paramPlace])
            ) {
            ...
            return (
              (c = e.extend(!0, {}, i.params, r.opts[t], d)),
              (f =
    ...
    (u.prototype.destroy = function () {
          ...
          (o.realPoints = o.startPoints = r(i)),
            o.startPoints.length &&
              ...
              (((o.opts || o.canPan) &&
                ...
                (1 === o.startPoints.length || d.hasError) &&
                  (o.canPan
        ...
        if (!0 !== l)
          ...
          if (
            ...
            a.group.length < 2 && s.opts.vertical
              ...
              : a.isDragging ||
                !1 === s.opts.vertical ||
                ("auto" === s.opts.vertical && n(e).width() > 800)
              ? (s.isSwiping = "x")
              : ((r = Math.abs(
      ...
      (u.prototype.limitMovement = function () {
        ...
        return (
          ...
          u > 0 && r > t && (r = t - 1 + Math.pow(-t + f + u, 0.8) || 0),
  ...
  (function (e) {
    ...
    var t = (function () {
        ...
        return (
              ...
              (function (t) {
                ...
                (h = function (e, t) {
                  ...
                  (p = function (e, n, i, r) {
                    ...
                    if (
                      ...
                      for (
                        ...
                        if ("require" === (d = (f = h(n[y], w)).f))
                          _[y] = g.require(e);
                        else if ("exports" === d)
                          (_[y] = g.exports(e)), (x = !0);
                        else if ("module" === d) c = _[y] = g.module(e);
                        else if (o(m, d) || o(v, d) || o(b, d)) _[y] = l(d);
                        else {
                          if (!f.p) throw new Error(e + " missing " + d);
                          f.p.load(f.n, s(r, !0), a(d), {}), (_[y] = m[d]);
                        }
                      (p = i ? i.apply(m[e], _) : void 0),
                        e &&
                          (c && c.exports !== t && c.exports !== m[e]
                            ? (m[e] = c.exports)
                            : (p === t && x) || (m[e] = p));
                    } else e && (m[e] = i);
                  }),
                  (e = n = f = function (e, n, i, o, r) {
                    if ("string" == typeof e)
                      return g[e] ? g[e](n) : l(h(e, u(n)).f);
                    if (!e.splice) {
                      if (((y = e).deps && f(y.deps, y.callback), !n)) return;
            ...
            function (e, t, n) {
              ...
              return (
                ...
                (i.prototype._attachCloseHandler = function (t) {
                  e(document.body).on("mousedown.select2." + t.id, function (
                    t
                  ) {
          ...
          t.define("select2/translation", ["jquery", "require"], function (
            e,
            t
          ) {
            function n(e) {
            ...
            function t(t) {
              ...
              if (
                ...
                if (
                  ...
                  (!r || f < r) && ((r = f), i(s, f) && (r /= 40)),
                  i(s, f) && ((c /= 40), (d /= 40), (p /= 40)),
  ...
  (function (e, t, n, i) {
    ...
    (s.prototype = {
      init: function () {
        var t = this,
          n = jQuery("<div/>", { class: "passtrengthMeter" }),
          i = jQuery("<div/>", {
            class: "tooltip",
        ...
        if (
          ...
          e(this.element).appendTo(n),
          this.options.tooltip)
        ) {
          i.appendTo(n);
          var o = i.outerWidth() / 2;
          i.css("margin-left", -o);
        }
        this.$elem.bind("keyup keydown", function (n) {
          (value = e(this).val()), t.check(value);
        }),
          this.options.passwordToggle && t.togglePassword();
      },
      check: function (e) {
        var t = 0,
          n = 0,
        ...
        (upperCase = new RegExp("[A-Z]")),
          ...
          (t = e.length >= this.options.minChars ? 1 : -1),
          (n = e.match(upperCase) ? 1 : 0),
          (i = e.match(i) ? 1 : 0),
          (o = e.match(specialchars) ? 1 : 0),
          (securePercentage = ((t + n + i + o) / 4) * 100),
          this.addStatus(securePercentage);
      },
      addStatus: function (t) {
        var n = "",
          i = "Min " + this.options.minChars + " chars",
          o = e(this.element).closest(".passtrengthMeter"),
          r = o.find(".tooltip");
        o.attr("class", "passtrengthMeter"),
          t >= 25 &&
            (o.attr("class", "passtrengthMeter"),
            (n = "weak"),
            (i = this.options.textWeak)),
          t >= 50 &&
            (o.attr("class", "passtrengthMeter"),
            (n = "medium"),
            (i = this.options.textMedium)),
          t >= 75 &&
            (o.attr("class", "passtrengthMeter"),
            (n = "strong"),
            (i = this.options.textStrong)),
          t >= 100 &&
            (o.attr("class", "passtrengthMeter"),
            (n = "very-strong"),
            (i = this.options.textVeryStrong)),
          o.addClass(n),
          this.options.tooltip && r.text(i);
      },
      togglePassword: function () {
        var t = jQuery("<span/>", {
          ...
          i = jQuery("<input/>", { type: "text" }),
          o = this;
        t.appendTo(e(this.element).closest(".passtrengthMeter")),
          i.appendTo(e(this.element).closest(".passtrengthMeter")).hide(),
          e(this.element).bind("keyup keydown", function (t) {
            i.val(e(o.element).val());
          }),
          i.bind("keyup keydown", function (t) {
            e(o.element).val(i.val()),
              (value = e(this).val()),
              _this.check(value);
          }),
          e(n).on("click", ".showPassword", function (n) {
            t.toggleClass("active"), i.toggle(), e(o.element).toggle();
          });
      },
    }),
      (e.fn[o] = function (t) {
  ...
  jQuery.fn.extend({
    createRepeater: function (e = {}) {
      var t = function (e) {
          return e.replace(/\[/g, "_").replace(/\]/g, "").toLowerCase();
        },
        n = function (e, n, o = !0) {
          var r = e,
            s = r.data("group");
          r.find("input,select").each(function (e, i) {
            var r = $(i).data("name");
            1 != $(i).data("skip-name")
              ? $(i).attr("name", s + "[" + n + "][" + r + "]")
              : "undefined" != r && $(i).attr("name", r),
              1 == o && $(i).attr("value", ""),
              $(i).attr("id", t($(i).attr("name"))),
              $(i)
                .parent()
                .find("label")
                .attr("for", t($(i).attr("name")));
          });
          var a = e,
            l = a.find(".remove-btn");
          0 == n ? l.attr("disabled", !0) : l.attr("disabled", !1),
            l.attr("onclick", "$(this).parents('.items').remove()");
          var c = $("<div class='items'>" + a.html() + "<div/>");
          c.attr("data-index", n), c.appendTo(i);
        },
        i = this,
        o = i.find(".items"),
        r = 0,
        s = i.find(".repeater-add-btn");
      o.each(function (t, i) {
        var s;
        o.remove(),
          (s = "showFirstItemToDefault"),
          e.hasOwnProperty(s) &&
          1 ==
            (function (t) {
              return e[t];
            })("showFirstItemToDefault")
            ? (n($(i), r), r++)
            : o.length > 1 && (n($(i), r), r++);
      }),
        s.on("click", function () {
  ...
  (function (factory) {
    ...
    function init(sec, force) {
      ...
      for (
        i = data.vals.length - 1, j = str.length - 1;
        i >= 0;
        i -= 1, j -= 1
      ) {
    ...
    function tick(digit) {
      ...
      if (digit === data.iSec) {
        ...
        tickTimeout +=
          Math.abs(data.seconds - data.sec) * tickTimeout - timeDiff;
...
$(document).ready(function () {
  ...
  $("#repeater").length &&
    $("#repeater").createRepeater({ showFirstItemToDefault: !0 }),
    $("#repeater2").length &&
      $("#repeater2").createRepeater({ showFirstItemToDefault: !0 }),
    $("#repeater3").length &&
      $("#repeater3").createRepeater({ showFirstItemToDefault: !0 }),
    $(".header-slider").length &&
      $(".header-slider").slick({ dots: !0, arrows: !1, autoplay: true }),
    $(".consult-slider").length &&
  ...
  $("#notification-span").length &&
    ...
    $(".select-form-control").length &&
      $(".select-form-control").select2({ dir: "rtl" }),
    $($(".joining-form")).length &&
    ...
    $(document).ready(function () {
      void 0 !== window.location.hash &&
        "#service_orders" == window.location.hash &&
        $("#pills-pills-consult-order-tab").click();
    });
});

$("#countdown").length && $("#countdown").timeTo({ start: false }, 3600);

// window.videoTimeStart();
function videoTimeStart() {
  $("#countdown").timeTo({ start: true, countdown: true }, 3600, function () {
    window.videoTimeEnd();
  });
}
...
$(document).ready(function () {
  ...
  if($(".custome-file-validation").length){
    $('.custome-file-validation').map(function(index, element){
      var maxSizeUpload = $(this).attr('data-file-upload');
      if (typeof maxSizeUpload !== typeof undefined && maxSizeUpload !== false) {
        maxSizeUpload=maxSizeUpload;
      }else{
        maxSizeUpload = 2;
      }  
      $(this).parent().parent().parent().append("<h6 class='max-note'>" + maxSizeUpload + ' ميجا هي اقصى حجم لرفع ملف ' + "</h6>");
  ...
  if($('.custome-file-validation').length){
    $('body').on('change', '.custome-file-validation', function(e){
      var fileName = e.target.files[0].name;
        $(this).parent().parent().parent().find('span').css("display", "block");
        $(this).parent().parent().parent().find('span').text(fileName);
        $(this).parent().parent().parent().find('a').css("display", "inline-block");
    })
  }
  
  if($('.custome-file-validation').length){
    $('body').on('change', '.custome-file-validation', function(){
      $(this).parent().parent().parent().find('a').addClass('custome-file-validation-delete');
    })
    $('body').on('click', '.custome-file-validation-delete', function(e){
        ...
        $(this).parent().find('.max-note').css("display", "block");
        e.preventDefault();
    })
  }
  ...
  if($(".personal-img-validation").length){
    $('.personal-img-validation').map(function(index, element){
      var maxSizeUpload = $(this).attr('data-file-upload');
      var maxSizeUpload = $(this).attr('data-file-upload');
      if (typeof maxSizeUpload !== typeof undefined && maxSizeUpload !== false) {
        maxSizeUpload=maxSizeUpload;
      ...
      $(this).parent().parent().append("<h6 class='personla-img-max-note'>" + maxSizeUpload + ' ميجا هي اقصى حجم لرفع ملف ' + "</h6>");
      $(".personal-img-validation").parent().parent().find('.personla-img-max-note').css('display', "block");
      $(this).parent().parent().parent().find('.personla-img-max-note').css('display', "block");
    })
  }
  ...
  if($('.personal-img-validation').length){
    $('body').on('click', '.personal-img-validation-delete', function(e){
      ...
      $(this).parent().find('.personla-img-max-note').css("display", "block");
      e.preventDefault();
    })
  }
  ...
  if ($(".custome-file-validation").length) {
    $('body').on('change', '.custome-file-validation', function(e){
      var maxSizeUpload = $(this).attr('data-file-upload');
      if (typeof maxSizeUpload !== typeof undefined && maxSizeUpload !== false) {
        maxSizeUpload=maxSizeUpload*1000000;
      }else{
      ...
      if(fileSizeUpload > maxSizeUpload){
        ...
        $(this).val("");
        $(this).parent().parent().parent().find(".max-note").css('display', 'block');
        $(this).parent().parent().parent().find("span").css('display', 'none');
  ...
  $('body').append('<div id="context-menu"><div class="item paste-item"><i class="fa fa-paste"></i> لصق</div></div>')
  ...
  if($(".paste-item").length){
    $(".paste-item").on("click", function () {
      var curPos = targetInput.selectionStart;
      var endPos = targetInput.selectionEnd;
    navigator.clipboard.readText().then((text) => (targetInput.value = (targetInput.value).slice(0, curPos) + text + (targetInput.value).slice(endPos))); // console.log(navigator.clipboard.readText());
  });
  }
